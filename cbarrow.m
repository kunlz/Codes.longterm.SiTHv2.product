function h = cbarrow(hcb,cmp,options)
...
if strcmpi(cb.Box,'on')
    ...
    if all([makerightarrow makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3)+cbpos(4)*sqrt(2)/1 cbpos(3) 0 -cbpos(4)*sqrt(2)/1 0],...
    ...
    if all([makerightarrow ~makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3)+cbpos(4)*sqrt(2)/1 cbpos(3) 0 0],...
    ...
    if all([~makerightarrow makeleftarrow])
        line(cbpos(1) +[0 cbpos(3) cbpos(3) 0 -cbpos(4)*sqrt(2)/1 0],...
    ...
    if all([makeuparrow makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3)/2 cbpos(3) cbpos(3) cbpos(3)/2 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4)+cbpos(3)*sqrt(2)/1 cbpos(4) 0 -cbpos(3)*sqrt(2)/1 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
    ...
    if all([makeuparrow ~makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3)/2 cbpos(3) cbpos(3) 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4)+cbpos(3)*sqrt(2)/1 cbpos(4) 0 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
    ...
    if all([~makeuparrow makedownarrow])
        line(cbpos(1) +[0 0 cbpos(3) cbpos(3) cbpos(3)/2 0],...
            cbpos(2) + [0 cbpos(4) cbpos(4) 0 -cbpos(3)*sqrt(2)/1 0],...
            'color',linecolor,'LineWidth',linewidth)
    end
end
